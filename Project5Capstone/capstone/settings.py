...
SECRET_KEY = "django-insecure-!@^@r)a3%%bwy*tsv#(mbr$wfg3qnk_6d5b=rricuc(kvbikpp"
...
# The base URL to access all user-uploaded files.
MEDIA_URL = "/media/"

# The root folder where all user-uploaded files will be stored.
